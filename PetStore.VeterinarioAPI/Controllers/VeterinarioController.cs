...
public class VeterinarioController : MasterCrudController<Veterinario>
{
    ...
    public VeterinarioController(ILogger<MasterCrudController<Veterinario>> logger, IVeterinarioService service, string includePatch = "Especialidade") : base(logger, service, includePatch)
    {
        _service = service;
    }
}